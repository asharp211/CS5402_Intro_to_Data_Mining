# From https://github.com/dahvreinhart/Rule-Based-
# PRISM/blob/master/prism.py

# Execute from command line as:
# python prism.py contact-lenses.arff
 
import os
#import arff, numpy as np

#from util2 import Arff2Skl       # No longer exists in util2
exec(open("Arff2Skl.py").read())  # Added this (JLL Sept. 2020)

# Put ()'s around all the print statements  (JLL Sept. 2020)
...
class Prism():
    ...
    def predict(test_data_file, rules):
        test_data = pickle.load(open(test_data_file, 'r+'))
        p = []
        return p
